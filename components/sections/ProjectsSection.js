  ...
  const projects = [
    {
      ...
      description: "A 2D platformer game with retro aesthetics and challenging gameplay mechanics.",
      tech: ["Unity", "C#", "Aseprite", "Photon"],
      image: "🏰",
      playLink: "#",
      codeLink: "#",
      status: "Released",
    ...
    },
    {
      ...
      description: "Virtual reality space shooter with immersive 3D environments and haptic feedback.",
      tech: ["Unreal Engine", "C++", "SteamVR", "Blender"],
      image: "🚀",
      playLink: "#",
      codeLink: "#",
    ...
    },
    {
      ...
      description: "Online co-op dungeon crawler with procedural generation and loot system.",
      tech: ["Unity", "Netcode", "C#", "MySQL"],
      image: "⚔️",
      playLink: "#",
      codeLink: "#",
      status: "Beta",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.map((project) => (
            <div
              key={project.id}
              className={`pixel-border bg-muted hover:bg-accent/10 transition-all duration-300 cursor-pointer p-4 ${
                selectedProject?.id === project.id ? 'bg-accent/20 pixel-shadow' : ''
              }`}
              onClick={() => setSelectedProject(project)}
            >
              <div className="text-4xl mb-4 text-center animate-pixel-bounce">
                {project.image}
              </div>
          ...
          <div className="mt-12 pixel-border bg-background p-6 pixel-shadow">
            <div className="flex flex-col lg:flex-row gap-6">
              <div className="lg:w-1/3">
                <div className="text-6xl text-center mb-4 animate-pixel-bounce">
              ...
              <div className="lg:w-2/3">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <a
                    ...
                    className="pixel-border bg-transparent border-secondary text-secondary px-6 py-3 text-center hover:bg-secondary hover:text-background transition-colors"
                  >
                    💻 VIEW CODE
                  </a>
                </div>
